...
# Checks for updates
def checkUpdate():
	updateUrl = "https://raw.githubusercontent.com/sabyrkit/Teams-Presence/master/doc/version"
	try:
		f = requests.get(updateUrl, timeout=10)
		latestVersion = float(f.text)
		if latestVersion > version:
			printwarning("There is an update available.")
			printwarning("Head over to https://github.com/sabyrkit/Teams-Presence to get the latest features.")
		else:
...
if __name__ == '__main__':
	...
	while True:
		...
		if jsonresult['activity'] == "Available":
			...
			print("Teams presence:\t\t" + '\033[33m' + "Busy" + '\033[0m')
			switchRed()
		elif jsonresult['activity'] == "InAConferenceCall":
			print("Teams presence:\t\t" + '\033[33m' + "In A Conference Call" + '\033[0m')
			switchRed()
		elif jsonresult['activity'] == "DoNotDisturb":
			print("Teams presence:\t\t" + '\033[33m' + "Do Not Disturb" + '\033[0m')
			switchRed()
		elif jsonresult['activity'] == "Offline":
			print("Teams presence:\t\t" + '\033[33m' + "Offline" + '\033[0m')
			switchPink()
		elif jsonresult['activity'] == "Inactive":
			print("Teams presence:\t\t" + '\033[33m' + "Inactive" + '\033[0m')
			switchYellow()
		elif jsonresult['activity'] == "InAMeeting":
			print("Teams presence:\t\t" + '\033[33m' + "InAMeeting" + '\033[0m')
			switchBlue()
		elif jsonresult['activity'] == "OffWork":
			print("Teams presence:\t\t" + '\033[33m' + "Off Work" + '\033[0m')
			switchPink()
		elif jsonresult['activity'] == "OutOfOffice":
			print("Teams presence:\t\t" + '\033[33m' + "Out Of Office" + '\033[0m')
			switchPink()
		elif jsonresult['activity'] == "Presenting":
			print("Teams presence:\t\t" + '\033[33m' + "Presenting" + '\033[0m')
			switchPurple()
		elif jsonresult['activity'] == "UrgentInterruptionsOnly":
			print("Teams presence:\t\t" + '\033[33m' + "Urgent Interruptions Only" + '\033[0m')
			switchRed()
		else:
